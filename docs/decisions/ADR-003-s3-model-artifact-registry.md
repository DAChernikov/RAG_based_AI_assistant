...
A future cache manager downloads to a temporary local file, verifies size and SHA-256,
...
- The existing retriever-artifact download remains a separate compatibility path until it is
